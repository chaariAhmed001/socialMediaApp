...
const Forms = () => {
  ...
  const  handleSubmit = (e) => { 
    e.preventDefault()
    currentID ? dispatch(updatePost(currentID,postData)) : dispatch(creatPost(postData))
   clear();
  }
  const clear = () =>{ dispatch(setCurrentPost(null)); setPostData({ creator: '', title: '', message: '', tags: '', selectedFile: '' });}
  return (
